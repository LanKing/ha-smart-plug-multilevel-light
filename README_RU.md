...
<a href="custom_components/smart_plug_multilevel_light/manifest.json"><img src="https://img.shields.io/badge/version-0.10.2-blue" alt="Version 0.10.2"></a>
...
lovelace:
  resource_mode: yaml
  resources:
    - url: /api/smart_plug_multilevel_light/smart-plug-multilevel-light-card.js?v=0.10.2
      type: module
```
...
```text
/api/smart_plug_multilevel_light/smart-plug-multilevel-light-card.js?v=0.10.2
```
