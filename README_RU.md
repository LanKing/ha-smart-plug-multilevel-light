...
7. Для каждого режима переключите лампу её физической кнопкой, откройте редактор режима и запустите **Test stable power**. После получения стабильного значения нажмите **Apply**. Например:
...
8. Сохраните helper. Home Assistant создаст новую сущность `light`, например `light.torsher`.
9. Откройте нужный Dashboard, включите режим редактирования и нажмите **Add card**.
10. Выберите **Smart Plug Multi-Level Light**, укажите созданную сущность `light` и сохраните карточку.
