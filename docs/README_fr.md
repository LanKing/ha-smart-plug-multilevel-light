...
5. Dans la rubrique**ZUI003Z**ajoutez au moins un mode de luminosité en cliquant sur**Ajouter**.<br /> <img src="https://raw.githubusercontent.com/LanKing/ha-smart-plug-multilevel-light/main/docs/modes-edit.png" width="465"/><br /><br />
Allumez la lampe avec son bouton physique, entrez le nom du mode et démarrez**Test stable power**. Après avoir obtenu une valeur stable, appuyez sur**Appliquer**.

6. Après avoir ajouté le premier mode, ajoutez les modes restants en répétant ces étapes. Vous devriez obtenir quelque chose comme :<br />
