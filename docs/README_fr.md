...
5. Dans la rubrique**ZUI003Z**ajoutez au moins un mode de luminosité en cliquant sur**Ajouter**.<br /> <img src="modes-edit.png" width="465"/>Allumez la lampe avec son bouton physique, entrez le nom du mode et démarrez**Test stable power**. Après avoir obtenu une valeur stable, appuyez sur**Appliquer**.
