...
5. Στην ενότητα **🔅 Λειτουργίες φωτεινότητας (🔅 Brightness modes)** προσθέστε τουλάχιστον μία λειτουργία φωτεινότητας κάνοντας κλικ **Προσθέτω**.<br /> <img src="modes-edit.png" width="465"/><br />
...
Αυτό το έργο διανέμεται με την άδεια [MIT](../LICENSE).
