...
> Integrace kombinuje nedigitálně ovládané svítidlo a chytrou zásuvku do jedné entity Home Assistant. Určuje stav a aktuální režim jasu na základě spotřeby energie, zobrazuje je na kartě a umožňuje rozsvítit lampu vypnutou vlastním tlačítkem krátkým zhasnutím a opětovným připojením napájení ze zásuvky.

# 🔌 Víceúrovňové světlo Smart Plug
...
* Karta je postavena na standardní dlaždicové kartě Home Assistant, zachovává její geometrii, pozadí, efekty vznášení, velikosti, typografii a standardní akce;
...
* Rozhraní je lokalizováno pro 64 národních prostředí Home Assistant.
...
> Můj soket automaticky nehlásí hodnoty do HA a umožňuje dotazování pouze v zadaném intervalu. Ve výchozím nastavení to bylo 60 sekund. Tento interval je nutné nastavit na 1 sekundu, jinak budete velmi dlouho čekat, než se objeví displej přepínání režimů.
...
Po změně restartujte prostředky Lovelace nebo restartujte Home Assistant.
