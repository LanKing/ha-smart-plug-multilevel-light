...
> Integratsioon ühendab mittedigitaalselt juhitava valgusti ja nutika pistiku üheks koduabilise üksuseks. See määrab oleku ja praeguse heleduse režiimi energiatarbimise põhjal, kuvab need kaardil ja võimaldab lülitada sisse oma nupuga väljalülitatud lambi, lülitades selle korraks välja ja ühendades uuesti voolu läbi pistikupesa.

# 🔌 Nutipistiku mitmetasandiline valgusti
...
* Kaart on ehitatud standardse Home Assistant Tile Cardi peale, säilitades selle geomeetria, tausta, hõljumise efektid, suurused, tüpograafia ja standardtoimingud;
...
* Liides on lokaliseeritud 64 koduabilise lokaadi jaoks.
...
koduabilise konfiguratsioonikataloogi:
...
Home Assistant ei luba integratsioonil ressursside loendit automaatselt muuta. Sellisel juhul lisage ressurss käsitsi:
...
Pärast muudatust taaskäivitage Lovelace'i ressursid või taaskäivitage Home Assistant.
...
1. Taaskäivitage Home Assistant täielikult.
