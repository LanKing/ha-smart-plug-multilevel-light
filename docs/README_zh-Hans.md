...
5. 在本节中**ZUI003Z**单击添加至少一种亮度模式**添加**.<br /> <img src="modes-edit.png" width="50%"/><br />用物理按钮开关灯，输入模式名称并启动**Test stable power**。获得稳定值后，按**申请**.
...
## 👋 您的支持
如果这个项目为您节省了一些时间，您可以 [支持我在GitHub Sponsors上的实验](https://github.com/sponsors/LanKing). ☕🔧
