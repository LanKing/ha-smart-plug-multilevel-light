...
5. セクション内**ZUI003Z**をクリックして少なくとも 1 つの明るさモードを追加します**追加**.<br /> <img src="modes-edit.png" width="50%"/><br />物理ボタンでランプを切り替え、モード名を入力して開始します**Test stable power**。安定した値が得られたら、 を押します。**適用する**.
