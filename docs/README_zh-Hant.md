...
5. 在本節中**ZUI003Z**點選新增至少一種亮度模式**添加**.<br /> <img src="https://raw.githubusercontent.com/LanKing/ha-smart-plug-multilevel-light/main/docs/modes-edit.png" width="465"/><br /><br />
用實體按鈕開關燈，輸入模式名稱並啟動**Test stable power**。獲得穩定值後，按**申請**.
