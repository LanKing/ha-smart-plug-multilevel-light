...
5. I avsnittet**ZUI003Z**lägg till minst ett ljusstyrkeläge genom att klicka**Tillägga**.<br /> <img src="https://raw.githubusercontent.com/LanKing/ha-smart-plug-multilevel-light/main/docs/modes-edit.png" width="465"/><br /><br />
Byt lampan med dess fysiska knapp, ange namnet på läget och starta**Test stable power**. Efter att ha erhållit ett stabilt värde, tryck**Tillämpas**.
