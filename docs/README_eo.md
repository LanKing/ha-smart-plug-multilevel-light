...
5. La ŝanĝoj **Mezura balotintervalo** je 1 s.
...
1. Sur la deponeja paĝo, alklaku **Kodo → Elŝutu ZIP**.
2. Malpaku la arkivon.
3. Kopiu la dosierujon:
...
Fina dosiera vojo `manifest.json` devus aspekti jene:
