...
5. En la sekcio**ZUI003Z**aldonu almenaŭ unu brilreĝimon per klako**Aldoni**.<br /> <img src="modes-edit.png" width="50%"/><br />Ŝaltu la lampon per ĝia fizika butono, enigu la nomon de la reĝimo kaj komencu**Test stable power**. Post akiri stabilan valoron, premu**Apliki**.
...
> \[! KONSILETO]**Ĉu vi ŝatis la solvon?**&#x52;igardu 🏠<a href="https://github.com/LanKing/ha-tools/blob/main/docs/README_eo.md">miaj aliaj produktoj por Hejma Asistanto</a>
