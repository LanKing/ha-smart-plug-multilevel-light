...
> Die integrasie kombineer 'n nie-digitaal beheerde ligarmatuur en 'n slimprop in een Home Assistant-entiteit. Dit bepaal die status en huidige helderheidsmodus gebaseer op kragverbruik, vertoon dit op 'n kaart en laat jou toe om 'n lamp wat met sy eie knoppie afgeskakel is, aan te skakel deur kortliks af te skakel en die krag weer deur die uitlaat aan te skakel.
...
* Die kaart is bo-op die standaard Home Assistant-teëlkaart gebou, wat sy geometrie, agtergrond, sweefeffekte, groottes, tipografie en standaardaksies behou;
...
* Die koppelvlak is gelokaliseer vir 64 tuisassistent-lokale.
...
na die Home Assistant-konfigurasiegids:
...
Home Assistant laat nie toe dat die integrasie die lys hulpbronne outomaties verander nie. Voeg in hierdie geval die hulpbron handmatig by:
...
1. Herbegin Home Assistant heeltemal.
