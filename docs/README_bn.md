...
5. বিভাগে **🔅 উজ্জ্বলতার মোড (🔅 Brightness modes)** ক্লিক করে অন্তত একটি উজ্জ্বলতা মোড যোগ করুন **যোগ করুন**.<br /> <img src="https://raw.githubusercontent.com/LanKing/ha-smart-plug-multilevel-light/main/docs/modes-edit.png" width="465"/><br /><br />
