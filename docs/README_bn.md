...
5. বিভাগে **ZUI003Z** ক্লিক করে অন্তত একটি উজ্জ্বলতা মোড যোগ করুন **যোগ করুন**.<br /> <img src="modes-edit.png" width="50%"/><br />
...
> \[!টিপ]
> **আপনি সমাধান পছন্দ করেন?** দেখুন 🏠 <a href="https://github.com/LanKing/ha-tools/blob/main/docs/README_bn.md">হোম সহকারীর জন্য আমার অন্যান্য পণ্য</a>
