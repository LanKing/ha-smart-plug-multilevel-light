...
5. বিভাগে **🔅 উজ্জ্বলতার মোড (🔅 Brightness modes)** ক্লিক করে অন্তত একটি উজ্জ্বলতা মোড যোগ করুন **যোগ করুন**.<br /> <img src="modes-edit.png" width="50%"/><br />
...
| পরামিতি | প্রকার | ডিফল্ট | গন্তব্য |
|---|---|---:|---|
| `entity` | স্ট্রিং | বাধ্যতামূলক | ইন্টিগ্রেশন দ্বারা সৃষ্ট সত্তা |
| `name` | স্ট্রিং | সত্তার নাম | কার্ডে নাম ওভাররাইড করে |
| `icon` | স্ট্রিং | সত্তা আইকন | আইকন পুনরায় সংজ্ঞায়িত করে |
| `show_mode` | বুলিয়ান | `true` | মোড নাম দেখায় |
| `show_percentage` | বুলিয়ান | `true` | শর্তসাপেক্ষ আগ্রহ দেখায় |
| `icon_tap_action` | কর্ম | `more-info` | আইকনে ক্লিক করার সময় অতিরিক্ত ক্রিয়া |
| `always_show_icon_background` | বুলিয়ান | `false` | সর্বদা আইকনের বৃত্তাকার পটভূমি দেখায়, এমনকি এর জন্য হলেও `icon_tap_action` "না" নির্বাচিত |
...
প্রকল্প লাইসেন্সের অধীনে বিতরণ করা হয় [MIT](../LICENSE).

<br />

> [!TIP]
> **আপনি সমাধান পছন্দ করেন?** দেখুন 🏠 <a href="https://github.com/LanKing/ha-tools/blob/main/docs/README_bn.md">জন্য আমার অন্যান্য পণ্য Home Assistant</a>
