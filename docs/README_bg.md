...
5. В секцията**🔅 Режими на яркост (🔅 Brightness modes)**добавете поне един режим на яркост, като щракнете**Добавете**.<br /> <img src="modes-edit.png" width="50%"/><br />Превключете лампата с нейния физически бутон, въведете името на режима и стартирайте**Test stable power**. След като получите стабилна стойност, натиснете**Кандидатствайте**.
...
| Параметър | Тип | По подразбиране | Дестинация |
|---|---|---:|---|
|`entity`| низ | задължително | образувание, създадено чрез интеграция |
|`name`| низ | име на обект | заменя името в картата |
|`icon`| низ | икона на обект | предефинира иконата |
|`show_mode`| булево |`true`| показва името на режима |
|`show_percentage`| булево |`true`| показва условна лихва |
|`icon_tap_action`| действие |`more-info`| допълнително действие при щракване върху иконата |
|`always_show_icon_background`| булево |`false`| винаги показва кръглия фон на иконата, дори ако за`icon_tap_action`„Не“ избран |
...
> \[!СЪВЕТ]**Хареса ли ви решението?**&#x412;ижте 🏠<a href="https://github.com/LanKing/ha-tools/blob/main/docs/README_bg.md">другите ми продукти за домашен асистент</a>
