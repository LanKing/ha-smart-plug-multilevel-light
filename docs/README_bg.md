...
5. Промените **Интервал на анкета на измерване** на 1 с.
...
4. Изберете тип **Интеграция** и натиснете **Добавете**.

> Добавянето на хранилище прави интеграцията достъпна само в HACS. За да инсталирате, трябва отделно да отворите картата му и да щракнете **Изтегляне**.
...
Краен път на файла `manifest.json` трябва да изглежда така:
