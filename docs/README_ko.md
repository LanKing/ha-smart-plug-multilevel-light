...
5. 섹션에서**ZUI003Z**클릭하여 하나 이상의 밝기 모드를 추가하세요.**추가하다**.<br /> <img src="modes-edit.png" width="465"/><br />물리적 버튼으로 램프를 전환하고 모드 이름을 입력한 후 시작하세요.**Test stable power**. 안정된 값을 얻은 후**적용하다**.
