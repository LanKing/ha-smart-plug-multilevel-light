...
* La targeta està construïda a sobre de la targeta de rajoles Home Assistant estàndard, conservant la seva geometria, fons, efectes de flotació, mides, tipografia i accions estàndard;
...
* La interfície està localitzada per a 64 configuracions locals de Home Assistant.
...
al directori de configuració de Home Assistant:
...
Després del canvi, reinicieu els recursos de Lovelace o reinicieu Home Assistant.
