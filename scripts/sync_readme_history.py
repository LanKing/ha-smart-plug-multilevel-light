...
def main() -> None:
    ...
    text = text.replace("version-0.8.0-blue", "version-0.9.7-blue")
    text = text.replace("Version 0.8.0", "Version 0.9.7")
    text = text.replace("?v=0.8.0", "?v=0.9.7")
    ...
    text = text.replace(
        ...
        "* Рассчитывает яркость линейно относительно максимальной мощности; округление рассчитанной яркости до 5% можно включать и отключать;",
    )
